...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Billing List</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
                    Add Bill</span>
            </div>
        </div>
    </div>
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('invoices.store') }}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            <div class="col">
                                <label for="inputName" class="control-label">Bill ID</label>
                                <input type="text" class="form-control" id="inputName" name="invoice_number"
                                       title="please add bill ID" required>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <label for="inputName" class="control-label">Achievement Amount</label>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <label for="inputName" class="control-label">Fees Amount</label>
